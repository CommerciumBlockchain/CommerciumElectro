...
from commerciumelectro.plugins import hook, DeviceMgr
from commerciumelectro.util import PrintError, UserCancelled, bh2u
from commerciumelectro.wallet import Wallet, Standard_Wallet
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from commerciumelectro.keystore import is_xprv
