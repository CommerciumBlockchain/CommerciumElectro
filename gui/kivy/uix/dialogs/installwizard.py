...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from commerciumelectro.mnemonic import Mnemonic
        from commerciumelectro.old_mnemonic import words as old_wordlist
...
class InstallWizard(BaseWizard, Widget):
    ...
    def new(self):
        ...
        wallet_kinds = [
            ...
            ('imported', _("Import CommerciumElectro addresses or private keys")),
        ]
    ...
    def import_addresses_or_keys(self):
        ...
        title = _("Import CommerciumElectro Addresses")
        message = _(
            "Enter a list of CommerciumElectro addresses (this will create a watching-only wallet), or a list of private keys.")
    ...
    def derivation_dialog(self, f):
        ...
        message = '\n'.join([
            ...
            _("If you want the wallet to use legacy CommerciumElectro addresses use m/44'/0'/0'"),
    ...
    def create_addresses(self):
        ...
        msg = _("CommerciumElectro wallet is generating your addresses, please wait.")
