...
title = CommerciumElectro

# (str) Package name
package.name = CommerciumElectro

# (str) Package domain (needed for android/ios packaging)
package.domain = org.commerciumelectro
...
presplash.filename = %(source.dir)s/gui/kivy/theming/commerciumelectro_presplash.png
