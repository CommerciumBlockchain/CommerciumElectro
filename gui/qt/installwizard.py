...
from commerciumelectro import Wallet, WalletStorage
from commerciumelectro.util import UserCancelled, InvalidPassword
from commerciumelectro.base_wizard import BaseWizard
...
MSG_GENERATING_WAIT = _("CommerciumElectro is generating your addresses, please wait...")
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "Commercium addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Commercium Electro  -  ' + _('Install Wizard'))
        ...
        self.set_icon(':icons/commerciumelectro.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Commercium Electro wallet'))
        ...
        if self.storage.requires_upgrade():
            self.hide()
            msg = _("The format of your wallet '%s' must be upgraded for CommerciumElectro. This change will not be backward compatible"%path)
            if not self.question(msg):
                return
    ...
    def init_network(self, network):
        message = _("CommerciumElectro communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfil the same purpose only differing in "
                  "hardware. In most cases you simply want to let CommerciumElectro "
